...
//0907 interface start

int rectX, rectY;      // Position of square button
int circleX, circleY;  // Position of circle button
int rectSize = 40;     // Button 1 size
int circleSize = 40;   // Button 2 size
int pos2X, pos2Y;
...
void draw() {
  ...
  rect(0, 0, pos2X, pos2Y);
  
  // tag add =======================================================
  
  
  
  if (tagInd>1&&tagInd<3){
   fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  ...
  if (tagInd>3&&tagInd<5){
   fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  }
  rect(50, height-80, 20, 20);
   fill(144);
  
  if (tagInd>5&&tagInd<7){
  fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  }
  rect(80, height-80, 20, 20);
  fill(144);
  
  if (tagInd>7&&tagInd<9){
   fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  }
  rect(110, height-80, 20, 20);
   fill(144);
  
  if (tagInd>9&&tagInd<11){
   fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  }
  rect(140, height-80, 20, 20);
  fill(144);
  
  if (tagInd>11&&tagInd<13){
   fill(RGB, 255,23,140);
  }
  else{
   fill(144);
  }
  rect(170, height-80, 20, 20);
  fill(144);
  ...
  stroke(0);
  rect(circleX, circleY, circleSize, circleSize/2);
...
void mousePressed() {
  ...
  if (mouseX>20&&mouseY>height-80&&mouseX<40&&mouseY<height-60)
  {
  tagInd = 2;
  } 
  
    if (mouseX>50&&mouseY>height-80&&mouseX<70&&mouseY<height-60)
  {
  tagInd = 4;
  } 
  
  
     if (mouseX>80&&mouseY>height-80&&mouseX<100&&mouseY<height-60)
  {
  tagInd = 6;
  } 
  
       if (mouseX>110&&mouseY>height-80&&mouseX<130&&mouseY<height-60)
  {
  tagInd = 8;
  } 
  
         if (mouseX>140&&mouseY>height-80&&mouseX<160&&mouseY<height-60)
  {
  tagInd = 10;
  } 
  
           if (mouseX>170&&mouseY>height-80&&mouseX<190&&mouseY<height-60)
  {
  tagInd = 12;
  } 
...
String tag() {
  ...
  if (tagInd>1&&tagInd<3){
   ...
   else if (tagInd>3&&tagInd<5){
   tagtag = "moveB";
   println(tagtag);
  }
  
  
   else if (tagInd>5&&tagInd<7){
   tagtag = "moveC";
   println(tagtag);
  }
  
    
   else if (tagInd>7&&tagInd<9){
   tagtag = "moveD";
   println(tagtag);
  }
  
   else if (tagInd>9&&tagInd<11){
   tagtag = "moveE";
   println(tagtag);
  }
  
  
   else if (tagInd>11&&tagInd<13){
   tagtag = "moveF";
   println(tagtag);
  }
